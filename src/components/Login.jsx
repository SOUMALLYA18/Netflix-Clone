    ...
    <div className="w-screen h-screen">
      ...
      <div className="absolute w-full h-full">
        ...
        <form
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black p-12  w-full lg:w-3/12 text-white flex flex-col rounded-[5px] bg-opacity-80 justify-center md:mt-6"
        >
