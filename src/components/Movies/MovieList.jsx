...
const MovieList = ({ title, movies, name }) => {
  ...
  return (
    <div className="px-4 text-white relative">
      <h1 className=" md:text-2xl lg:text-2xl text-lg py-2 leading-tight">
        {title}
      </h1>
      <div className="relative">
        ...
        <div className="md:flex">
          ...
          <FaChevronLeft
            className="slider-button absolute left-0 top-1/2 transform -translate-y-1/2 z-10 text-white cursor-pointer opacity-10 hover:opacity-100 bg-gradient-to-r from-black w-12 h-[70%] hidden lg:block"
            size={20}
          ...
          <FaChevronRight
            className="slider-button absolute right-0 top-1/2 transform -translate-y-1/2 z-10 text-white cursor-pointer opacity-10 hover:opacity-100 bg-gradient-to-r from-black w-12 h-[70%] hidden lg:block"
            size={40}
            onClick={() => handleArrowClick(100)}
          />
        </div>
